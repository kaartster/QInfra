...
from qgis.core import (
    QgsRectangle, QgsCoordinateReferenceSystem, QgsCoordinateTransform, QgsProject, QgsWkbTypes, QgsRasterLayer
)
from qgis.gui import QgsMapTool, QgsRubberBand
import os

from .pdok_lagen import (
    voeg_pdok_luchtfoto_wmts_toe, exporteer_luchtfoto_bbox, zorg_voor_project_crs_rdnew,
    maak_of_update_projectgebied_layer, lees_projectgebied_rect
)
...
class QInfraPlugin:
    ...
    def open_download_dialog(self):
        ...
        if not rect_rd:
            QMessageBox.information(self.iface.mainWindow(), "QInfra",
